...
const I18N = {
    fr: {
        ...
        'work.intro': 'Huit réalisations, une idée claire par carte. Cliquez pour ouvrir le site.',
    ...
    en: {
        ...
        'work.intro': 'Eight projects, one clear idea per card. Click to open the site.',
        'work.view': 'View site',
